...
`mimic`, `mimic_demo`, `eicu`, `eicu_demo`, `hirid` and `aumc` are
...
data, have a look at `?setup_src_data`. The full version of this
...
from `mimic` which is not available. Alternatively, data from
`mimic_demo` is used instead.
\end{CodeOutput}
\end{CodeChunk}
...
\begin{CodeOutput}
Note: The following code chunk(s) are intended to be run using data
from `eicu` which is not available. Alternatively, data from
`eicu_demo` is used instead.
\end{CodeOutput}
\end{CodeChunk}
...
\begin{CodeOutput}
Note: The following code chunk(s) are intended to be run using data
from `mimic` and `eicu` which is not available. Alternatively, data
from `mimic_demo` and `eicu_demo` is used instead.
\end{CodeOutput}
\end{CodeChunk}
...
2     2  9000 secs 0.750
3     3 12600 secs 1.24
4     4 16200 secs 0.899
5     5 19800 secs 0.295
\end{CodeOutput}
\end{CodeChunk}
...
\begin{center}\includegraphics{/private/var/folders/24/8k48jl6d249_n_qfxwsl6xvm0000gn/T/Rtmpjzah3r/file8657e57b94a/articles/jss_files/figure-latex/cox_plot-1} \end{center}
...
\begin{center}\includegraphics{/private/var/folders/24/8k48jl6d249_n_qfxwsl6xvm0000gn/T/Rtmpjzah3r/file8657e57b94a/articles/jss_files/figure-latex/diabetes_visualize-1} \end{center}
