...
\begin{CodeOutput}
Note: The following code chunk(s) are intended to be run using data
from `mimic`, `eicu` which is not available. Alternatively, data from
`mimic_demo`, `eicu_demo` is used instead.
\end{CodeOutput}
\end{CodeChunk}
...
1     1  5400 secs  0.913
2     2  9000 secs  1.14
3     3 12600 secs  0.738
4     4 16200 secs -0.805
5     5 19800 secs  0.152
\end{CodeOutput}
\end{CodeChunk}
...
\begin{center}\includegraphics{/private/var/folders/24/8k48jl6d249_n_qfxwsl6xvm0000gn/T/RtmphHzDCQ/file724642c300a/articles/jss_files/figure-latex/cox_plot-1} \end{center}
...
\begin{center}\includegraphics{/private/var/folders/24/8k48jl6d249_n_qfxwsl6xvm0000gn/T/RtmphHzDCQ/file724642c300a/articles/jss_files/figure-latex/diabetes_visualize-1} \end{center}
