...
The following sections serve to introduce \pkg{ricu} by covering two
central aspects that are key to both using and extending \pkg{ricu}, as
...
\item
  ...
  \pkg{ricu}. As a starting point for those unfamiliar with theses
...
\item
  ...
  with \pkg{ricu} for the default data sources, while Section
...
highlighting some further functionality provided by \pkg{ricu} that
...
1     1  5400 secs -1.89
2     2  9000 secs  1.67
3     3 12600 secs  0.905
4     4 16200 secs  1.71
5     5 19800 secs -0.328
\end{CodeOutput}
\end{CodeChunk}
