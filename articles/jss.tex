...
\item
  ...
  \item
    ...
    snippet in Section \ref{data-sources})
  \item
...
\begin{CodeOutput}
<aumc_env[7]>
         admissions           drugitems       freetextitems           listitems 
      [23,106 x 17]    [4,907,269 x 31]      [651,248 x 11]   [30,744,065 x 11] 
       numericitems procedureorderitems        processitems 
 [977,625,612 x 15]     [2,188,626 x 8]       [256,715 x 6] 
\end{CodeOutput}
\end{CodeChunk}
...
from
\href{https://CRAN.R-project.org/package=ricu/vignettes/uom.html}{CRAN}.
\end{quote}
...
2     2  9000 secs  0.669
3     3 12600 secs  1.21
4     4 16200 secs -0.254
5     5 19800 secs  0.0305
\end{CodeOutput}
\end{CodeChunk}
...
\begin{center}\includegraphics{/private/var/folders/24/8k48jl6d249_n_qfxwsl6xvm0000gn/T/RtmppcV1AL/file6ab7714b210/articles/jss_files/figure-latex/cox-plot-1} \end{center}
...
\begin{center}\includegraphics{/private/var/folders/24/8k48jl6d249_n_qfxwsl6xvm0000gn/T/RtmppcV1AL/file6ab7714b210/articles/jss_files/figure-latex/diabetes-visualize-1} \end{center}
