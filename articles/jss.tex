...
Furthermore, \pkg{ricu} was designed with extensibility in mind such
that adding further public and/or private user-provided datasets is
possible. Being implemented in \proglang{R}, a programming language
...
comparatively simple data layout comprising only 5 tables\footnote{The
  ...
  preprocessing stages from \citep{hyland2020}. While \pkg{ricu} focuses
...
\pkg{ricu} is available as dataset \texttt{miiv}. Compared to MIMIC-III,
...
concept-specific preprocessing. Furthermore, abstractions that allow for
code re-use for common data transformation tasks are important for
simplifying both code development and maintenance. Building on this
framework, \pkg{ricu} has included a dictionary with over 100 concepts
...
1     1  5400 secs -1.38
2     2  9000 secs  1.01
3     3 12600 secs  0.835
4     4 16200 secs  0.278
5     5 19800 secs  1.79
\end{CodeOutput}
\end{CodeChunk}
...
# Duration var: `c`
      a b       c            d
  <int> <drtn>  <drtn>   <dbl>
1     1 1 hours 90 mins 0.150
2     2 2 hours 90 mins 0.512
3     3 3 hours 90 mins 0.873
4     4 4 hours 90 mins 0.546
5     5 5 hours 90 mins 0.0545
\end{CodeOutput}
\begin{CodeInput}
R> expand(dat)
\end{CodeInput}
...
function), little has to be done in terms of preprocessing: values are
...
is intended for covering unit conversions\footnote{A more recent
  addition to \pkg{ricu} has been experimental support for automatic
  unit conversion using the \pkg{units} package \citep{pebesma2016}. In
...
{\centering \includegraphics{/private/var/folders/24/8k48jl6d249_n_qfxwsl6xvm0000gn/T/RtmpAK46hZ/file6a243003ec7/articles/jss_files/figure-latex/src-setup-1} 
...
object, which together with associated metadata are used by \pkg{ricu}
...
{\centering \includegraphics{/private/var/folders/24/8k48jl6d249_n_qfxwsl6xvm0000gn/T/RtmpAK46hZ/file6a243003ec7/articles/jss_files/figure-latex/data-loading-1} 
...
\begin{center}\includegraphics{/private/var/folders/24/8k48jl6d249_n_qfxwsl6xvm0000gn/T/RtmpAK46hZ/file6a243003ec7/articles/jss_files/figure-latex/cox-plot-1} \end{center}
...
preprocessing steps outlined above: first data is subsetted to fall into
the first 24 hours of ICU admissions, followed by binning of summed
values.
...
\begin{center}\includegraphics{/private/var/folders/24/8k48jl6d249_n_qfxwsl6xvm0000gn/T/RtmpAK46hZ/file6a243003ec7/articles/jss_files/figure-latex/diabetes-visualize-1} \end{center}
