...
\begin{CodeChunk}
\begin{CodeOutput}
Note: Examples in this vignette require that datasets `mimic`,
`mimic_demo`, `eicu`, `eicu_demo`, `hirid` and `aumc` are available.
Chunks that depend on certain datasets will not be evaluated if the
corresponding dataset is missing. The full version of this vignette is
available from
...
# Id var:      `a`
      a b                c
  <int> <drtn>       <dbl>
1     1  5400 secs  0.0592
2     2  9000 secs  1.58
3     3 12600 secs -1.05
4     4 16200 secs -0.528
5     5 19800 secs  1.07
\end{CodeOutput}
\end{CodeChunk}
