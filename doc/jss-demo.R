...
## ----mimic-tbls, eval = srcs_avail("mimic_demo")------------------------------
mimic_demo

## ----eicu-tbls, eval = srcs_avail("eicu_demo")--------------------------------
eicu_demo

## ----src-overview, eval = srcs_avail(c("mimic_demo", "eicu_demo")), echo = FALSE, results = "asis"----
as_quant <- function(x) {
...
## ----cox-model, eval = srcs_avail("mimic_demo")-------------------------------
src <- "mimic_demo"
...
## ----cox_plot, eval = srcs_avail("mimic_demo"), echo = FALSE, warning = FALSE, message = FALSE, fig.width = 8, fig.height = 6----
theme_fp <- function(...) {
  theme_bw(...) +
...
## ----ins24, eval = srcs_avail("mimic_demo")-----------------------------------
...
## ----diab, eval = srcs_avail("mimic_demo")------------------------------------
...
## ----diabetes-visualize, echo = FALSE, eval = srcs_avail("mimic_demo"), fig.width = 8, fig.height = 6----
