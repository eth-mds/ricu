...
test_that("id_tbl constructors", {
  ...
  expect_error(index_var(tbl), "not a `ts_tbl` object")
  expect_error(index_col(tbl), "not a `ts_tbl` object")
  ...
  expect_error(index_var(ptyp), "not a `ts_tbl` object")
  expect_error(index_col(ptyp), "not a `ts_tbl` object")
