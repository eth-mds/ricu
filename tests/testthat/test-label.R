...
test_that("sofa", {
  ...
  expect_identical(id(sofa), "hadm_id")
  ...
  expect_identical(id(sowin), "hadm_id")
  ...
  expect_identical(id(score), "hadm_id")
...
test_that("suspicion of infection", {
  ...
  expect_identical(id(siwin), "hadm_id")
...
test_that("sepsis 3", {
  ...
  expect_identical(id(sep3), "hadm_id")
