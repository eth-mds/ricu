...
1. Place tables converted to `.fst` files into the folder returned by `src_data_dir("dataset_name")` (or write methods for `src_download()` and `src_import()`).
