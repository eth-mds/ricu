...
1. Requesting access to datasets and data source setup:
    ...
    * demo datasets can be set up by installing the data packages `mimic.demo` and/or `eicu.demo`, passing `"https://eth-mds.github.io/physionet-demo"` as `repos` argument to `install.packages()` (see code snippet in Section \ref{data-sources})
