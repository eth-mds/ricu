...
cfg <- list(
  ...
  CALLOUT = list(
    col_spec = list(
      ...
      ACKNOWLEDGETIME = list(type = "col_datetime",
                             format = "%Y-%m-%d %H:%M:%S"),
      OUTCOMETIME = list(type = "col_datetime", format = "%Y-%m-%d %H:%M:%S"),
  ...
  PROCEDUREEVENTS_MV = list(
    col_spec = list(
      ...
      COMMENTS_EDITEDBY = list(type = "col_character"),
      COMMENTS_CANCELEDBY = list(type = "col_character"),
      COMMENTS_DATE = list(type = "col_datetime", format = "%Y-%m-%d %H:%M:%S")
    )
  ),
  PROCEDURES_ICD = list(
    col_spec = list(
  ...
  SERVICES = list(
    col_spec = list(
      ...
      SUBJECT_ID = list(type = "col_integer"),
      HADM_ID = list(type = "col_integer"),
      TRANSFERTIME = list(type = "col_datetime", format = "%Y-%m-%d %H:%M:%S"),
...
jsonlite::write_json(cfg, "config-mimic.json", auto_unbox = TRUE,
                     pretty = TRUE)
